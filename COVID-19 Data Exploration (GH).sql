...
-- Shows % of Population that has died due to COVID
...
-- Shows increase in percentage of population fully vaccinated
...
-- Calculating % of population that contracted COVID and % of population that has passed away due to COVID
